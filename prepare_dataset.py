...
def select_mem_non_mem_indices(dataset_path):
    ...
    mem_indices = random.sample(doc_ids, 1000)
    non_mem_indices = random.sample(doc_ids, 1000)
...
for dataset in datasets:
    ...
    print(f"Saved 200 mem and 200 non-mem indices for {dataset} in {output_file}")