...
class Llama3(Model):
    def __init__(self, config):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained('/datasets/ai/llama3/huggingface/llama-3-8b-instruct')
        self.model = AutoModelForCausalLM.from_pretrained('/datasets/ai/llama3/huggingface/llama-3-8b-instruct', device_map="auto", torch_dtype=torch.float16)
